...
a persistence unit "clienteRESTPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "clienteREST\pom.xml":
...
artifact ("clienteREST.war") is already built. You can build
